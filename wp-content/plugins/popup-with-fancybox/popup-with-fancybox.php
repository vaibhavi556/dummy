...
function Popupwfb_widget_init()
{
	...
	{
		wp_register_sidebar_widget( __('Popup with fancybox', 'popup-with-fancybox'), __('Popup with fancybox', 'popup-with-fancybox'), 'Popupwfb_widget');
	}
	
	if(function_exists('wp_register_widget_control')) 
	{
		wp_register_widget_control(__('Popup with fancybox', 'popup-with-fancybox'), array( __('Popup with fancybox', 'popup-with-fancybox'), 'widgets'), 'Popupwfb_control');
	} 
}
