...
Captus WordPress Theme, Copyright 2019-2020 WordPress.org
Captus is distributed under the terms of the GNU GPL.
...
Captus is derived from the Chaplin Theme, Copyright 2019 Anders Norén
Chaplin Theme is distributed under the terms of the GNU GPL version 2.0

Captus bundles the following third-party resources:
...
Bespoke Icons Created For Captus
License: Creative Commons Zero (CC0), https://creativecommons.org/publicdomain/zero/1.0/
...
- captus_the_theme_svg()
- captus_get_theme_svg()
- captus_nav_menu_social_icons()
